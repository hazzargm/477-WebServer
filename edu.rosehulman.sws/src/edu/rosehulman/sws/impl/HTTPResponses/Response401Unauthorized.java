 ...
 * 
 */
public class Response401Unauthorized extends AbstractHttpResponse {

	public Response401Unauthorized(String version, File file) {
		this.version = version;
		this.code = Protocol.UNAUTHORIZED_CODE;
		this.phrase = Protocol.UNAUTHORIZED_TEXT;
		this.header = new HashMap<String,String>();
		this.file = file;
	}
	
	public Response401Unauthorized() {
		this.code = Protocol.UNAUTHORIZED_CODE;
		this.phrase = Protocol.UNAUTHORIZED_TEXT;
		this.header = new HashMap<String,String>();
	}
