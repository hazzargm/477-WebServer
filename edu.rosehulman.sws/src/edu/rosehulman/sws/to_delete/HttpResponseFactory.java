...
//	 */
//	public static void fillGeneralHeader(IHTTPResponse response, String connection) {
...
//	 */
//	public static IHTTPResponse create200OK(File file, String connection) {
//		IHTTPResponse response = new HttpResponse(Protocol.VERSION, Protocol.OK_CODE, 
...
//	 */
//	public static IHTTPResponse create400BadRequest(String connection) {
//		IHTTPResponse response = new HttpResponse(Protocol.VERSION, Protocol.BAD_REQUEST_CODE, 
...
//	 */
//	public static IHTTPResponse create404NotFound(String connection) {
//		IHTTPResponse response = new HttpResponse(Protocol.VERSION, Protocol.NOT_FOUND_CODE, 
...
//	 */
//	public static IHTTPResponse create505NotSupported(String connection) {
...
//	 */
//	public static IHTTPResponse create304NotModified(String connection) {
//		// TODO fill in this method
//		return null;
//	}
//}
